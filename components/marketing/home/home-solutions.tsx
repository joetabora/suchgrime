...
export function HomeSolutions() {
  return (
    <section id="solutions" className="poster-section border-b border-white/10 bg-bg-elevated py-24 md:py-32">
              ...
              <Link href={solution.href} className="group block h-full">
                <GlassCard hover className="flex h-full flex-col">
                  <div className="flex items-start justify-between gap-2">
                    <h3 className="font-display text-xl tracking-wide text-text group-hover:text-parlor-accent">
                      {solution.title}
                    </h3>
                    <ArrowUpRight className="h-4 w-4 shrink-0 text-muted transition-transform group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-parlor-accent" />
                  </div>
