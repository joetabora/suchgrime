    ...
    <>
      <header className="fixed inset-x-0 top-0 z-40 border-b border-white/10 bg-bg">
        ...
        >
          <a
            href="#"
            className="flex flex-col justify-center border-r border-white/10 px-6 py-4"
          >
          ...
          <ul className="flex flex-1 flex-col justify-center px-6">
            {parlor.navLinks.map((link, i) => (
              <li key={link.href} className="border-b border-white/10">
                ...
                >
                  <span className="font-mono text-sm text-parlor-accent">
