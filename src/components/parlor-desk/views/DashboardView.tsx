  ...
  return (
    <div className="space-y-8">
      ...
      <p className="text-xs text-muted">
        View all{" "}
        <Link to="/work/parlor-desk/appointments" className="text-desk-accent hover:underline">
          appointments
        </Link>{" "}
        or browse your{" "}
        <Link to="/work/parlor-desk/clients" className="text-desk-accent hover:underline">
          client list
        </Link>
        .
      </p>
