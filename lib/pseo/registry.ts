...
export const pseoCollections: Record<PseoCollectionId, PseoCollectionConfig> = {
  locations: {
    ...
    indexDescription: "Custom software, business automation, and web systems for Wisconsin and cities across the United States.",
  ...
  industries: {
    ...
    indexDescription: "Custom business applications, automation, and web systems for healthcare, legal, home services, and more.",
    schemaType: "WebPage",
    matrixWithServices: true,
    priority: 0.75,
    changeFrequency: "monthly",
  ...
  services: {
    ...
    path: "/services",
    indexTitle: "Services",
    indexDescription: "Custom software, AI automation, web development, and e-commerce solutions from SuchGrime.",
    schemaType: "Service",
    priority: 0.85,
    changeFrequency: "monthly",
  },
  "case-studies": {
    ...
    indexDescription: "Case studies and project capabilities — custom apps, internal dashboards, automation, and websites built by SuchGrime.",
